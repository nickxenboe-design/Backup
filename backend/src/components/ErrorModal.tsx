...
const ErrorModal: React.FC<ErrorModalProps> = ({ isOpen, onClose, title, message, details, primaryActionLabel, onPrimaryAction, maxWidth }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-3" role="dialog" aria-modal="true" aria-labelledby="error-modal-title">
      <div className={`relative bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-xl w-full ${sizeClass} max-h-[90vh] overflow-y-auto animate-fade-in-down border border-gray-200 dark:border-gray-700`}>
        <div className="p-4">
          <div className="flex items-start">
            ...
            <div className="flex-1">
              <h2 id="error-modal-title" className="text-base font-bold text-red-700 dark:text-red-300">{title}</h2>
