...
export interface SearchQuery {
  ...
  passengers: { adults: number; children: number; seniors?: number; students?: number };
...
export interface BusRoute {
  ...
  arrivalTime: string;
  /** Full raw datetime/timestamp for departure (ISO or Unix), used for accurate date mapping */
  departureDateTimeRaw?: string;
  /** Full raw datetime/timestamp for arrival (ISO or Unix), used for accurate date mapping */
