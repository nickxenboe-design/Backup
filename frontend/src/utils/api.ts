    ...
    const payload = {
      ...
      passengers: transformedPassengers.map((passenger, index) => {
        ...
        return {
          ...
          answers: [
            { question_key: 'dob', value: passenger.dateOfBirth || '' },
            ...(passenger.idNumber ? [{ question_key: 'id_number', value: passenger.idNumber }] : []),
            ...(passenger.nationality ? [{ question_key: 'nationality', value: passenger.nationality }] : [])
          ]
        };
      }),
