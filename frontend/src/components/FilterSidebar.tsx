...
const FilterSection: React.FC<{ title: string; isOpen: boolean; onToggle: () => void; rightSlot?: React.ReactNode; children: React.ReactNode }> = ({ title, isOpen, onToggle, rightSlot, children }) => (
      ...
      >
            ...
            {availableOperators.length > 0 && (
                <FilterSection
                    ...
                    onToggle={() => setOpenSections((prev) => ({ ...prev, operators: !prev.operators }))}
