      ...
      try {
        ...
        if (ticketId) {
          ...
          if (response.success) {
            ...
            setErrorModalTitle(mapped.title);
            setErrorModalMessage(mapped.message);
    ...
    return (
      <>
        ...
        <ErrorModal
          ...
          title={errorModalTitle || 'Ticket not available'}
          message={errorModalMessage || 'We could not load your ticket right now. Please try again.'}
