...
const AdminDashboard: React.FC = () => {
  ...
  const [activeSection, setActiveSection] = useState<'overview' | 'middleware' | 'pricing' | 'ads' | 'admins' | 'agents' | 'users' | 'reports'>('overview');
                  ...
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-[11px]">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                      {profitabilityRows.length === 0 ? (
                        <tr>
                          <td colSpan={15} className="py-3 text-center text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <tfoot className="bg-gray-50 dark:bg-gray-800/80">
                      ...
                      <tr>
                        <td colSpan={15} className="px-2 pb-2 text-[10px] text-gray-500 dark:text-gray-400">
