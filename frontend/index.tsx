...
import './src/utils/agentHeaders';
import './index.css';

const DEFAULT_THEME_PRIMARY = '#652D8E';
const DEFAULT_THEME_ACCENT = '#F59E0B';

const ENV_THEME_PRIMARY = String((import.meta as any).env?.VITE_THEME_PRIMARY || '').trim();
const ENV_THEME_ACCENT = String((import.meta as any).env?.VITE_THEME_ACCENT || '').trim();
const HAS_ENV_THEME = Boolean(ENV_THEME_PRIMARY || ENV_THEME_ACCENT);
...
applyThemeVars({
  primary: ENV_THEME_PRIMARY || DEFAULT_THEME_PRIMARY,
  accent: ENV_THEME_ACCENT || DEFAULT_THEME_ACCENT,
});
